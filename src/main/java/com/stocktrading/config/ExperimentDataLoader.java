...
public class ExperimentDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        long existingCount = experimentStockRepository.count();
        if (existingCount >= 15) {
            System.out.println("Experiment stocks ready: " + existingCount);
            return;
        }

        System.out.println("========================================");
        System.out.println("ENSURING 15 EXPERIMENT STOCKS");
        System.out.println("========================================");
        ...
        for (int i = 1; i <= 15; i++) {
            ...
            ExperimentStock expStock = experimentStockRepository
                    .findBySequenceOrder(i - 1)
                    .orElseGet(ExperimentStock::new);
            ...
            System.out.println("  Ensured stock " + i + ": " + stockSymbol + " (" + marketTrend + ")");
        }

        System.out.println("Experiment stocks ensured:");
